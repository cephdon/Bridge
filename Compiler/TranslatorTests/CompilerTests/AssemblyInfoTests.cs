...
namespace Bridge.Translator.Tests
{
    ...
    internal class AssemblyInfoTests
    {
        ...
        public void AssemblyInfoDefault()
        {
            ...
            Assert.AreEqual(FileNameCaseConvert.None, config.FileNameCasing, "FileNameCasing");
            ...
            Assert.False(config.CombineScripts.NoCore, "CombineScripts.NoCore");
            Assert.False(config.CombineScripts.NoReferenced, "CombineScripts.NoReferenced");
